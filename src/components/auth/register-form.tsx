      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div>
          ...
          <div className="relative mt-1">
            ...
            <Input id="full_name" placeholder="Your full name" className="pl-10" {...register('full_name')} />
          </div>
        ...
        <div>
          ...
          <div className="relative mt-1">
            <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />
            <Input id="confirm_password" type="password" placeholder="Repeat password" className="pl-10" {...register('confirm_password')} />
          </div>
        ...
        <p className="text-xs text-gray-400">
          ...
          <a href="/terms" className="text-[#0057FF] hover:underline">Terms of Service</a> and{' '}
          <a href="/privacy" className="text-[#0057FF] hover:underline">Privacy Policy</a>.
        </p>
